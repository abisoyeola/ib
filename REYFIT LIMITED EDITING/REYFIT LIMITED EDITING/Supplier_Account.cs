...
namespace POS_SALES
{
    public partial class Supplier_Account : Form
    {
        ...
        void Fillcombos()
        {
            ...
            string Query = "select * from bottle_sales_pos.vendor;";
            ...
            try
            {
                ...
                while (myReader.Read())
                {
                    string sfull_name = myReader.GetString("vn");
        ...
        private void Expenditure_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                this.gclass.DGVTable("SELECT id as 'S/N',pdate as 'POSTING DATE',supplierid as 'SUPPLIER ID',supplier_name as 'SUPPLIER NAME',mode as 'PAYMENT MODE',recieptno as 'INVOICE NO',paymentno as 'PAYMENT NO',entry_type as 'ENTRY TYPE',debit as 'DEBIT',credit as 'CREDIT',discount as 'DISCOUNT',balance as 'BALANCE',postedby as 'POSTEDBY' FROM supplier_account", this.dataGridView1);
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                cmd = new MySqlCommand("SELECT id as 'S/N',pdate as 'POSTING DATE',supplierid as 'SUPPLIER ID',supplier_name as 'SUPPLIER NAME',mode as 'PAYMENT MODE',recieptno as 'INVOICE NO',paymentno as 'PAYMENT NO',entry_type as 'ENTRY TYPE',debit as 'DEBIT',credit as 'CREDIT',discount as 'DISCOUNT',balance as 'BALANCE',postedby as 'POSTEDBY' FROM supplier_account WHERE pdate >= '" + dateTimePicker1.Value.ToString("yyyy/MM/dd") + "' AND  pdate <= '" + dateTimePicker2.Value.ToString("yyyy/MM/dd") + "' AND supplier_name = '" + desc.Text + "'", cn);
            }
            else
            {
                cmd = new MySqlCommand("SELECT id as 'S/N',pdate as 'POSTING DATE',supplierid as 'SUPPLIER ID',supplier_name as 'SUPPLIER NAME',mode as 'PAYMENT MODE',recieptno as 'INVOICE NO',paymentno as 'PAYMENT NO',entry_type as 'ENTRY TYPE',debit as 'DEBIT',credit as 'CREDIT',discount as 'DISCOUNT',balance as 'BALANCE',postedby as 'POSTEDBY' FROM supplier_account WHERE pdate >= '" + dateTimePicker1.Value.ToString("yyyy/MM/dd") + "' AND  pdate <= '" + dateTimePicker2.Value.ToString("yyyy/MM/dd") + "'", cn);
            }
