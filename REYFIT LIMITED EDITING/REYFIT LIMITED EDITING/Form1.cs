    ...
    public partial class Form1 : Form
    {
        ...
        private void button7_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                MySqlCommand jh = new MySqlCommand("insert into customer_account (pdate,customerid,customer_name,mode,recieptno,paymentno,entry_type,credit,balance,postedby)VALUES('" + DateTime.Now.ToString("yyyy/MM/dd") + "','" + customer_id.Text + "','" + customer_name.Text + "','" + mode.Text + "','" + code.ToString() + "','" + code.ToString() + "','" + Program.PAYMENT + "','" + txtAmtpaid.Text + "','" + lblBalance.Text + "','" + Program.user + "')", cn);
                jh.ExecuteNonQuery();
