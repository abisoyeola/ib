...
namespace POS_SALES
{
    public partial class Product_Journal_Empties : Form
    {
        private General gclass = new General();
        public static string identify = "10";
        private string tab = null;
        private string newstk;
        public Product_Journal_Empties()
        {
            InitializeComponent();
        }
