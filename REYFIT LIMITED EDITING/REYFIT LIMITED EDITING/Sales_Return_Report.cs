    ...
    public partial class Sales_Return_Report : Form
    {
        ...
        private void toolStripButton4_Click_1(object sender, EventArgs e)
        {
            try
            {
                ...
                kashier = this.dataGridView1.SelectedRows[0].Cells[5].Value.ToString();
                total_amount = this.dataGridView1.SelectedRows[0].Cells[7].Value.ToString();
                new Sales_Return_detail().ShowDialog();
            }
            catch (Exception)
            {
            }
        ...
        private void button1_Click_1(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string[] strArray = new string[] { "SELECT * FROM sales_return_summary WHERE pdate BETWEEN '", this.dateTimePicker1.Value.ToString("yyyy/MM/dd"), "' AND '", this.dateTimePicker2.Value.ToString("yyyy/MM/dd"), "'  " };
                ...
                while (true)
                {
                    ...
                    if (!flag)
                    {
                        ...
                        while (true)
                        {
                            ...
                            if (!flag)
                            {
                                ...
                                while (true)
                                {
                                    if (num8 >= num6)
                                    {
                                        ...
                                        strArray = new string[] { "Sales Return Analysis Report Summary From (", this.dateTimePicker1.Value.ToString("yyyy/MM/dd"), ") To (", this.dateTimePicker2.Value.ToString("yyyy/MM/dd"), ")" };
                                    ...
                                    while (true)
                                    {
                                        ...
                                        str2 = this.dataGridView1.Rows[num4].Cells[5].Value.ToString();
                                        if (str == str2)
                                        {
                                            num7 += Convert.ToDecimal(this.dataGridView1.Rows[num4].Cells[7].Value);
                                        }
                                        num4++;
                                    }
                                }
                            ...
                            num3 += Convert.ToDecimal(this.dataGridView1.Rows[num4].Cells[7].Value);
                            this.dataGridView1.Rows[num4].Cells[0].Value = (num4 + 1).ToString();
                            str = this.dataGridView1.Rows[num4].Cells[5].Value.ToString();
                    ...
                    this.dataGridView1.Rows[num].Cells[2].Value = reader.GetString("pdate");
                    this.dataGridView1.Rows[num].Cells[3].Value = reader.GetString("entry_type");
                    this.dataGridView1.Rows[num].Cells[4].Value = reader.GetString("recieptno");
                    this.dataGridView1.Rows[num].Cells[5].Value = reader.GetString("cashier");
                    this.dataGridView1.Rows[num].Cells[6].Value = reader.GetString("postedby");
                    this.dataGridView1.Rows[num].Cells[7].Value = reader.GetString("total");
                }
            }
            catch (Exception exception)
            {
        ...
        private void Sales_Return_Report_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                MySqlDataReader reader = new MySqlCommand("SELECT * FROM sales_return_summary", this.gclass.conn()).ExecuteReader();
                while (true)
                {
                    bool flag = reader.Read();
                    if (!flag)
                            ...
                            if (!flag)
                            {
                                ...
                                while (true)
                                {
                                    if (num8 >= num6)
                                    {
                                        ...
                                        this.dataGridView1.Rows[num10].Cells[3].Value = $"{num3:N}";
                                        this.lbltotalAmt.Text = $"{num3:N}";
                                        this.reportTitle = "Sales Return Analysis Report Summary Till Date (" + this.dateTimePicker1.Value.ToString("yyyy/MM/dd") + ")";
                                        break;
                                    }
                                    str = this.listBox1.Items[num8].ToString();
                                    num4 = 0;
