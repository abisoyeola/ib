...
namespace POS_SALES
{
    public partial class Return_Supplier : Form
    {
                    ...
                    try
            {
                ...
                while (true)
                {
                    ...
                    else
                    {
                        ...
                        {
                                    int num7 = 0;
                                    string[] strArray = new string[] { "RS", DateTime.Now.Day.ToString(), DateTime.Now.Month.ToString(), DateTime.Now.Hour.ToString(), DateTime.Now.Minute.ToString(), DateTime.Now.Second.ToString(), Program.user_id.ToString() };
                                    string str = string.Concat(strArray);
                                    //string str3 = this.dataGridView1.Rows[x].Cells[9].Value.ToString();
                                    //this.dataGridView1.Rows[x].Cells[9].Value = Convert.ToDecimal(this.dataGridView1.Rows[x].Cells[4].Value) + Convert.ToDecimal(this.dataGridView1.Rows[x].Cells[2].Value);
                                    ...
                                    MySqlCommand hh = new MySqlCommand("insert into return_detail (purcase_id,pdate,code,description,stock,lpc,cp,qty,total,invoice_date)VALUES('" + str + "','" + today.Value.ToString("yyyy/MM/dd") + "','" + dataGridView1.Rows[tt].Cells[0].Value + "','" + dataGridView1.Rows[tt].Cells[1].Value + "','" + dataGridView1.Rows[tt].Cells[2].Value + "','" + dataGridView1.Rows[tt].Cells[3].Value + "','" + dataGridView1.Rows[tt].Cells[5].Value + "','" + dataGridView1.Rows[tt].Cells[4].Value + "','" + dataGridView1.Rows[tt].Cells[9].Value + "','" + invoiceDate.Value.ToString("yyyy/MM/dd") + "')", cn);
                                    ...
                                    MySqlCommand jhg = new MySqlCommand("insert into post_empty_stock (pdate,post4,category,postedby)VALUES('" + label18.Text + "','" + dataGridView1.Rows[tt].Cells[4].Value + "','" + dataGridView1.Rows[tt].Cells[11].Value + "','" + Program.user + "')", cn);
                                    jhg.ExecuteNonQuery();
                                    MySqlCommand yy = new MySqlCommand(@"UPDATE product SET stk_empty = '" + (Convert.ToInt32(dataGridView1.Rows[tt].Cells[2].Value) - Convert.ToInt32(dataGridView1.Rows[tt].Cells[4].Value)) + "' WHERE code = '" + dataGridView1.Rows[tt].Cells[0].Value + "'", cn);
                                    yy.ExecuteNonQuery();
                                    jh.ExecuteNonQuery();
                                    hh.ExecuteNonQuery();
                                    }
                                MySqlCommand button1 = new MySqlCommand(@"INSERT INTO return_invoice(code,p_date,odrn,vendor_code,vendor_name,vendor_add,post_grp,total,discount,amt_less_discount,postedby,invoice_date)VALUES('" + str + "','" + today.Value.ToString("yyyy/MM/dd") + "','" + orderno.Text + "','" + code.Text + "','" + name.Text + "','" + address.Text + "','" + pstgrp.Text + "','" + txtTotal.Text + "','" + discount2.Text + "','" + due.Text + "','" + Program.user + "','" + invoiceDate.Value.ToString("yyyy/MM/dd") + "')", cn);
            ...
            try
            {
                if (this.label3.Text == "0")
                {
                    ...
                    if (!string.IsNullOrWhiteSpace(Search_Product.descptn))
                    {
                        ...
                        this.dataGridView1.Rows[num3].Cells[2].Value = Search_Product.stock_empty;
                        ...
                        this.dataGridView1.Rows[num3].Cells[12].Value = Search_Product.stock;
                        this.dataGridView1.Focus();
